package ru.ylab.tasks.task5.constant;
...
public final class SqlConstants {
    ...
    /**
     * SQl для создания кастомных схем для liquibase миграций
     * */
    public static final String CREATE_LIQUIBASE_SCHEMA = "CREATE SCHEMA IF NOT EXISTS liquibase;";
    public static final String CREATE_MARKETPLACE_SCHEMA = "CREATE SCHEMA IF NOT EXISTS marketplace;";
